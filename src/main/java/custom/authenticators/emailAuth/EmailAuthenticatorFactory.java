...
public class EmailAuthenticatorFactory implements AuthenticatorFactory {
    private final String DISPLAY_TYPE = "Email authenticator";
    private final AuthenticationExecutionModel.Requirement[] REQUIREMENT_CHOICES = {
            AuthenticationExecutionModel.Requirement.REQUIRED,
            AuthenticationExecutionModel.Requirement.ALTERNATIVE,
            AuthenticationExecutionModel.Requirement.DISABLED
    };
    private final EmailAuthenticator SINGLETON = new EmailAuthenticator();
    private final String PROVIDERID = "emailauth";
